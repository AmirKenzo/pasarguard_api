...
class AdminRoleMixin:
    async def create_role(self, role: AdminRoleCreate, token: str | None = None) -> AdminRoleResponse:
        url = "/api/admin-role"
        params = None
        headers = None
    ...
    async def get_role(self, role_id: int, token: str | None = None) -> AdminRoleResponse:
    ...
    async def modify_role(self, role_id: int, role: AdminRoleModify, token: str | None = None) -> AdminRoleResponse:
        url = f"/api/admin-role/{role_id}"
        params = None
        headers = None
    ...
    async def delete_role(self, role_id: int, token: str | None = None) -> None:
        url = f"/api/admin-role/{role_id}"
        params = None
        headers = None
    ...
    async def get_roles_simple(self, token: str | None = None) -> AdminRolesSimpleResponse:
