...
class SettingsMixin:
    async def get_settings(self, token: str | None = None) -> SettingsSchema:
        url = "/api/settings"
        params = None
        headers = None
    ...
    async def modify_settings(self, settings: SettingsSchema, token: str | None = None) -> SettingsSchema:
        url = "/api/settings"
        params = None
        headers = None
    ...
    async def get_general_settings(self, token: str | None = None) -> General:
