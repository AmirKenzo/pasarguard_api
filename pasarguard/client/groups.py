...
class GroupsMixin:
    ...
    async def get_all_groups(self, token: str, ids: Optional[List[int]] = None, offset: Optional[int] = None, limit: Optional[int] = None) -> GroupsResponse:
        url = '/api/groups'
    ...
    async def get_groups_simple(self, token: str, ids: Optional[List[int]] = None, offset: Optional[int] = None, limit: Optional[int] = None, search: Optional[str] = None, sort: Optional[str] = None, all: Optional[bool] = False) -> GroupsSimpleResponse:
    ...
    async def get_group(self, group_id: int, token: str) -> GroupResponse:
        url = '/api/group/{group_id}'.format(group_id=group_id)
        params = None
        headers = None
        response = await self._request('GET', url, token=token, params=params, headers=headers)
        return self._parse_response(response, GroupResponse)
